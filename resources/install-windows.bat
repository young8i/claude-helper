...
set "CLAUDE_ZH_STAGE=%TEMP%\ClaudeZhHelperInstaller"
...
if errorlevel 1 (
    ...
    echo Please copy the whole Claude Chinese helper folder to a local Windows path, then run install-windows.bat again.
    pause
    exit /b 1
)
